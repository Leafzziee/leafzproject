...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE LEAFZ OFFC                [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "leafziee" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke LEAFZ${NC}"
    echo -e "${YELLOW}TELEGRAM : @leafezlee${NC}"
    echo -e "${YELLOW}WHATSAPP : 6287858976852${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©LeafzOFFC${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${GREEN}         ,ggggggggggggggggg.                                   ${NC}"
  echo -e "${BLUE}       ,ggggg        gggggggg.                                 ${NC}"
  echo -e "${RED}      ,ggg'               'ggg.                                ${NC}"
  echo -e "${GREEN}  ',gg        ,ggg.      'ggg:                               ${NC}"
  echo -e "${BLUE}  'ggg       ,gg'''  .    ggg       Auto Installer LEAFZ     ${NC}"
  echo -e "${RED}    gggg       gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${GREEN}  ggg:      gg.     -   ,ggg       • Telegram : @leafezlee   ${NC}"
  echo -e "${BLUE}    ggg:      ggg._    _,ggg        • Creadit  : LeafzOFFC    ${NC}"
  echo -e "${RED}     ggg.     '.'''ggggggp           • Support by LEAFZ        ${NC}"
  echo -e "${GREEN}    'ggg     '-.__                                           ${NC}"
  echo -e "${BLUE}       ggg                                                   ${NC}"
  echo -e "${RED}         ggg                                                 ${NC}"
  echo -e "${GREEN}         ggg.                                              ${NC}"
  echo -e "${BLUE}            ggg.                                            ${NC}"
